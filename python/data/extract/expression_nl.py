...
#               All the words came from raw reviews with no lemmatization.
...
#Input        : all the text file in "../raw_nolem" location
#Output       : expression_nl.dat dump in "../classification"
#Usage        : $python expression_nl.py
...
fout = open("../classification/exp_nl.dat", "wb")
