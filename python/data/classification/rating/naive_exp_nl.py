#Program name : naive_exp_nl.py
#Author       : LAM Wai Man
#Student ID   : 07010702
#Description  : To build a naive bayes classifier and test with 5-folder cross validation. Expression model. No lemmatization.
#Input        : goodbad_nl.dat, ../exp_nl.dat
#Output       : features.dat
#Usage        : $python naive_exp_nl.py
...
tag = []
#class label
fin = open("goodbad_nl.dat", "rb")
documents = pickle.load(fin)
fin.close()

#word frequency dictionary
fin = open("../exp_nl.dat", "rb")
...
dict1 =  classifier.show_most_informative_features(n=500)
