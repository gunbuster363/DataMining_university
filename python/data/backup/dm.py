...
while (url!=''):
  ...
  try:
    ...
    continue
  review_no = 0
  con.execute("create table if not exists " +filename+" (Id INT, review text, triptype TEXT, value INT, rooms INT, location INT, cleanliness INT, service INT, Date_Of_Stay TEXT, Visit_Was_For TEXT, Traveled_With TEXT, PRIMARY KEY (Id))")
  result = con.fetchall()
  print result
